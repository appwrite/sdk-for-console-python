...
class Client:
    def __init__(self):
        ...
        self._global_headers = {
            'content-type': '',
            'user-agent' : f'AppwritePythonSDK/0.2.1 ({platform.uname().system}; {platform.uname().version}; {platform.uname().machine})',
    ...
    def set_mode(self, value):
        self._global_headers['x-appwrite-mode'] = value
    ...
    def set_platform(self, value):
        ...
        self._global_headers['x-appwrite-platform'] = value
