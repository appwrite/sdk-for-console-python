...
from ..models.usage_presence import UsagePresence
...
class Presences(Service):
    ...
    def get_usage(
        self,
        range: Optional[UsageRange] = None
    ) -> UsagePresence:
        """
        ...
        return self._parse_response(response, model=UsagePresence)
