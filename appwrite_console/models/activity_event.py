...
class ActivityEvent(AppwriteModel):
    ...
    resourceparent: str = Field(
        ...,
        alias='resourceParent',
    )
    ...
    autonomoussystemnumber: str = Field(
        ...,
        alias='autonomousSystemNumber',
    )
    autonomoussystemorganization: str = Field(
        ...,
    ...
    connectionusagetype: str = Field(
        ...,
        alias='connectionUsageType',
    )
    connectionorganization: str = Field(
        ...,
